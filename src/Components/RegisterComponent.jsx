...
function RegisterComponent() {
    ...
    return (
        ...
        >
            ...
            <h1 className='font-normal text-4xl text-center m-3'>Make the most of your professional life</h1>
            <div className=' mx-[38%] shadow-lg bg-white flex flex-col p-10 rounded-lg'>
             ...
             border-black my-3 h-16 p-3 text-xl rounded-md'
                ...
                <h1 className='text-sm text-center'>By clicking Agree & Join or Continue, you agree to the LinkedIn User Agreement, Privacy Policy, and Cookie Policy.</h1>
                <button
                    className='rounded-full font-semibold bg-blue-700 text-white h-14 my-6'
                    onClick={register}
                    type='submit'
                >Agree & join</button>
